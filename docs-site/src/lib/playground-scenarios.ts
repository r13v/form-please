...
export const scenarios: readonly Scenario[] = [
	{
		...
		source: editorSource(basicSource),
	},
	{
		id: "transform",
		title: "Typed output",
		...
		source: editorSource(transformSource),
	},
	{
		id: "conditional",
		...
		source: editorSource(conditionalSource),
	},
	{
		id: "array",
		title: "Arrays",
		...
		source: editorSource(arraySource),
	},
	{
		id: "typo",
		...
		source: editorSource(typoSource),
	},
]
