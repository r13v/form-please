...
Read [Localization](/localization#translate-the-form-kit-labels) for the
complete localization steps.
...
`moveItemDown`, and `chooseFile`. All properties are optional. Read
[Localization](/localization#translate-the-form-kit-labels) for the key names of
each preset.
